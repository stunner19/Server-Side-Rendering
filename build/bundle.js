...
var app = (0, _express2.default)(); // babel-polyfill is used for the regenerator runtime. Needs to be included on both the client and the server side.
...
app.use(_express2.default.static('public')); // this directory is available to everyone.
...
exports.default = [_extends({}, _App2.default, { // App will always be displayed on the screen.
    routes: [_extends({}, _HomePage2.default, { // equivalent to component : Homepage. Check the export statement in the Homepage component.
        path: '/',
        exact: true
